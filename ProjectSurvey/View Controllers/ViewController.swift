...
class ViewController: UIViewController {
    ...
    func setUpElements() {
        ...
        //view.setGradientBackground(colorOne: #colorLiteral(red: 0.3112901146, green: 0.4078973915, blue: 0.4427833526, alpha: 1), colorTwo: #colorLiteral(red: 0.6308100139, green: 0.8265786389, blue: 0.8972728646, alpha: 1))
